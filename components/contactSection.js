      ...
      <Container className="flex flex-wrap mb-10 lg:gap-10 lg:flex-nowrap ">
        <div
          ...
          <form className="space-y-6 w-full" onSubmit={handleSubmit}>
                ...
                <div className="mt-4 mb-4">
                    <label htmlFor="message" className="block text-md font-medium leading-6 text-gray-700 dark:text-white mb-2">Message</label>
                    <textarea name="message" type="message" className="w-full rounded appearance-none bg-white text-gray-700 border py-4 px-4 leading-tight focus:outline-none focus:bg-white"  placeholder="Enter message..." onChange={(e) => setPassword(e.target.value)}></textarea>
                </div>
          ...
          <div>
            <div className="flex flex-col w-full mt-4">
              ...
              <p className="max-w-2xl py-4 text-lg leading-normal text-gray-500 lg:text-xl xl:text-xl dark:text-gray-300">
                Experts Corner customer support team is always ready to answer your questions and provide all the necessary assistance. Chat With Us and eel free to email your questions, suggestions, and comments to support. We are available Monday to Friday (8am to 6pm) call us CHAT WITH US You can also reach us on (A NUMBER WILL BE PROVIDED) from Monday to Friday (8am to 6pm) Please use the FAQ page for questions.
              </p>
            </div>
            <div className="flex flex-col w-full mt-4">
              <h3 className="max-w-2xl my-3 text-3xl font-bold leading-snug tracking-tight text-gray-800 lg:leading-tight lg:text-4xl dark:text-white">
                ...
                <div className="flex max-w-2xl text-lg leading-normal text-gray-500 lg:text-xl xl:text-xl dark:text-gray-300">
                    <div className="w-20">Email:</div>
                    <div className="">partners@expertscorner.com</div>
                </div>
            </div>
          </div>
        </div>
