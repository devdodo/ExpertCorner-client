    ...
    return (
        <div className="w-[90%] sm:w-[80%]  mt-9 mb-9 mx-auto">
            ...
            <div className="bg-white rounded overflow-hidden">
                <div className="p-8 bg-indigo-700 flex flex-col md:flex-row md:items-center justify-between">
                ...
                <div className="p-8">
                    <div className="text-gray-600 flex flex-col md:flex-row md:items-center border-b md:border-none border-gray-200 pb-6 md:pb-0 mb-4">
                        <div className="flex">
                    ...
                    <div className="text-gray-600 flex flex-col md:flex-row md:items-center mb-8">
                        <div className="flex">
                    ...
                    <div className={`${requestData[0].status === "unconfirmed"? "bg-yellow-100 text-yellow-600": "bg-green-200 text-green-700"} px-8  py-6 mb-6 rounded flex flex-col md:flex-row justify-between`}>
                        ...
                        <h3 className="text-md font-bold mt-4 md:mt-0">{requestData[0].status}</h3>
                    </div>
