        ...
        {userNIN === "" ? (
          <div>
            <p className="block text-gray-700 text-md font-bold mb-2">
              Kindly update Profile NIN and Phone Number to request for
              services!
            </p>
          </div>
        ) : (
          <form className="w-full max-w-lg" onSubmit={handleSubmit}>
              ...
              <div className="w-full px-3">
                ...
                <div className="relative">
                  <select
                    ...
                    onBlur={(e) => getVendorList(e.target.value)}
                  >
              ...
              <div className="w-full px-3">
                ...
                <div className="relative">
                  <select
                    ...
                    onBlur={(e) => handleVendorPrice(e.target.value)}
                  >
                    <option value="">Choose a Vendor</option>
                    {vendorList.map((vendor, index) => (
                      <option key={index} value={vendor.id}>
                        {vendor.nameOfVendor} - ₦ {vendor.service_charge} -{" "}
                        {vendor.maxCapacityTag} hours per day
                      </option>
                    ))}
                  </select>
                  <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700">
            ...
            <div className="flex flex-wrap -mx-3 mb-2">
              ...
              <div className="w-full md:w-2/3 px-3 mb-6 md:mb-0">
                <h3 className="block text-gray-500 text-sm font-bold mb-2">
                  Total:
                </h3>
                <h3 className="block text-gray-700 text-4xl font-bold">
                  ₦ {totalPrice}
                </h3>
              </div>
            </div>
